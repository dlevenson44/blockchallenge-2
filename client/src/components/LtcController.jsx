...
class LtcController extends Component {
    ...
    getData() {
        if (this.state.fetchStatus === false) {
            ...
            .then(res => {
                this.setState({
                    usd: res.data.crypto[0].ltc_usd,
                    usHigh: res.data.crypto[0].ltc_us_high,
                    usLow: res.data.crypto[0].ltc_us_low,
                    eur: res.data.crypto[0].ltc_eur,
                    eurHigh: res.data.crypto[0].ltc_eur_high,
                    eurLow: res.data.crypto[0].ltc_eur_low,
                    trades: res.data.crypto[0].ltc_trades,
                    oneHour: res.data.crypto[0].ltc_one_hour,
                    oneDay: res.data.crypto[0].ltc_24_hours,
                    oneWeek: res.data.crypto[0].ltc_7_days,
                    fetchStatus: true,
                })
            })
